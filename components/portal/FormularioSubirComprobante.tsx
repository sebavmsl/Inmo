...
/**
 * Corrección de esta sesión: antes pedía el "código de contrato" como
 * texto libre — un inquilino real no lo sabe de memoria. Ahora se elige
 * de una lista con los contratos activos que ya devuelve
 * getInquilinoContratos() (mismo dato que ya arma el selector de
 * /portal/mi-cuenta cuando hay más de una empresa/propiedad).
 */
export function FormularioSubirComprobante({ contratos }: { contratos: InquilinoContrato[] }) {
